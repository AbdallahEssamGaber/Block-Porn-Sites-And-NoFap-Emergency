	...
	*/
	GetPageList()
	{
		...
		try{
			...
			fullScriptPath = D:\PROJECTS\Programming\AHK\Block Sites\Examples\Block sites Chrome.exe
	...
	class Page
	{
		...
		*/
		Event(EventName, Event)
		{
			...
			{
				DetectHiddenWindows, On 
				fullScriptPath = D:\PROJECTS\Programming\AHK\Block Sites\Examples\edge with chrome lib.exe
				WinClose, %fullScriptPath% ahk_class AutoHotkey
